...
- User overrides from ~/.config/opencode/oh-my-opencode-medium.json
...
```markdown
# Repository Atlas: oh-my-opencode-medium
...
- `oh-my-opencode-medium.json`: User configuration schema.
